...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('infrastructure', '0005_auto_20210401_1409'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='comment',
            name='publisher_org',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_comment', to='infrastructure.organization'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='publisher_user',
        ...
        migrations.AlterField(
            model_name='post',
            name='publisher_org',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='org_post', to='infrastructure.organization'),
        ),
        migrations.AlterField(
            model_name='post',
            name='publisher_user',
